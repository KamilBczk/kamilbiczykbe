      ...
      <div className='wrapper'>
        <div className='container'>
          ...
          <div className='text-box'>
            <p className='p-m'>Greedy Glide est un projet créé lors de mon BAC 1 marketing. Au début notre équipe désirait que nous finissions premier de notre promotion mais au fil du temps nous sommes rendu compte que celui-ci trouve son public lors des analyses micro-économiques. En clair plus le temps passait plus notre projet nous paraissais serieux jusqu'à un point ou nous avons envisager de créer une start-up. Découvrez toutes les analyses, designs, et conception.</p>
          </div>
        </div>
      </div>
      <div className='wrapper'>
        <div className='container'>
          ...
          <div className='text-box'>
            <p className='p-m'>Notre idée de baume de massage aphrodisiaque serait composée de fruits invendus de marchés (notre matière première), de vitamines (pour la conservation), d'huiles essentielles (pour accentuer l'odeur), et d'ingrédients possédant des vertus aphrodisiaques (comme le gingembre, le thym, le chocolat, …). Ce baume pourrait être utilisé pendant vos moments de complicité mais aussi pendant vos moments de détente personnelle.</p>
          </div>
        </div>
      </div>
      <div className='wrapper'>
